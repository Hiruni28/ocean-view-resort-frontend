    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 border border-slate-200">
        <h3 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
          <span className="bg-gradient-to-br from-purple-100 to-pink-100 text-purple-600 rounded-full w-12 h-12 flex items-center justify-center mr-3 shadow-md">
        ...
        <div className="space-y-4">
          ...
          <div className="border-2 border-gray-200 rounded-xl overflow-hidden transition-all hover:border-purple-300">
            <button
            ...
            {openSection === 'login' && (
              <div className="p-6 bg-white border-t-2 border-purple-200">
                ...
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-5 mb-4 border-l-4 border-purple-500">
                  <div className="flex items-start gap-3 mb-3">
                    <Lock className="w-5 h-5 text-purple-600 mt-0.5" />
                    <p className="font-bold text-purple-800 text-lg">Login Process:</p>
                  </div>
