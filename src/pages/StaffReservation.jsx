        ...
        <div className="bill-print-area max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden print:shadow-none print:rounded-none">
          ...
          <div className="p-8">
            ...
            <div className="mb-6 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border-l-4 border-purple-500">
              ...
              <p className="text-2xl font-bold text-purple-600">#{billData.id}</p>
            </div>
            ...
            <div className="mt-6 text-center text-gray-600 text-sm">
              ...
              <p>We look forward to hosting you. For any queries, please contact us.</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl border-l-4 border-purple-500">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Number of Nights:</span>
                <span className="text-xl font-bold text-purple-600">{nights || 0}</span>
              </div>
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white py-4 rounded-lg font-bold text-lg hover:from-purple-600 hover:to-pink-600 transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
          >
