    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-pink-50 py-10 px-4">
        <div className="bill-print-area max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden print:shadow-none print:rounded-none">
          ...
          {/* Header */}
          <div className="bg-gradient-to-r from-purple-500 to-pink-500 p-8 text-center print:bg-white print:text-gray-800">
            ...
            <p className="text-white text-lg font-medium print:text-gray-600">Premium Beach Resort</p>
            <p className="text-purple-100 text-sm mt-2 print:text-gray-500">
            ...
            <div className="mb-6 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border-l-4 border-purple-500">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-2xl font-bold text-purple-600">#{edit.id}</p>
                </div>
                <div>
        ...
        <div className="bg-gradient-to-r from-purple-500 to-pink-500 p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right bg-white/20 px-6 py-3 rounded-xl">
              ...
              <div className="text-xs text-purple-100">Total Reservations</div>
            </div>
          </div>
        </div>
          ...
          <div className="mb-6">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all outline-none"
              />
            </div>
          </div>
                  ...
                  filteredReservations.map((r) => (
                    <tr key={r.id} className="hover:bg-purple-50 transition-colors">
                      <td className="px-4 py-4">
                        <span className="font-semibold text-purple-600">#{r.id}</span>
                      </td>
                      <td className="px-4 py-4">
                        <div className="flex items-center gap-2">
                      ...
                      <td className="px-4 py-4">
                        <div className="flex gap-2 justify-center flex-wrap">
                          ...
                          <button
                            onClick={() => setEdit(r)}
                            className="flex items-center gap-1 bg-pink-100 text-pink-700 px-3 py-1.5 rounded-lg hover:bg-pink-200 transition-all text-xs font-medium border border-pink-200"
                          >
            ...
            <div className="bg-gradient-to-r from-purple-500 to-pink-500 p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-purple-100 text-sm">Update reservation details</p>
                </div>
              </div>
            </div>
